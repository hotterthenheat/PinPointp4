...
==================================================
  ...
  quick actions to untrack or review in Sky's Vision.
==================================================
*/
...
const TrackedCard = ({ tracked, live, onUntrack, onReview }: TrackedCardProps) => {
  ...
  return (
    <div className="border border-borderSubtle bg-panel rounded-lg overflow-hidden flex flex-col">
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-borderSubtle">
        ...
        <VerdictBadge verdict={live.verdict} dot />
      ...
      {/* Live metrics grid */}
      <div className="grid grid-cols-3 gap-px bg-borderSubtle/30">
      ...
      <div className="px-4 py-2.5">
        ...
        <div className="h-1 rounded-full bg-white/[0.06] overflow-hidden">
          <span className="block h-full rounded-full bg-bull/80 transition-all duration-500" style={{ width: `${live.confidence}%` }} />
        </div>
      </div>
...
const TABLE_COLUMNS: Column<{ tracked: TrackedSetup; live: Setup }>[] = [
  {
    key: 'contract',
    header: 'Contract',
  ...
  },
  {
    key: 'verdict',
    header: 'Verdict',
    render: r => <VerdictBadge verdict={r.live.verdict} />,
  },
  {
    key: 'score',
    header: 'Score',
