  ...
  return (
    <div className={`border rounded-md overflow-hidden transition-colors ${
      ...
      >
        ...
        {setup.topOpportunity && <SignalBadge tone="select">TOP OPPORTUNITY</SignalBadge>}
        ...
        <span className="ml-auto flex items-center gap-3">
          <span className="hidden sm:flex items-center gap-2 font-mono text-[10px] text-textMuted uppercase tracking-wider">
            ...
            {setup.topRated && <SignalBadge tone="bull">TOP RATED</SignalBadge>}
          </span>
      ...
      {expanded && (
        <div className="border-t border-borderSubtle px-3 py-3 flex flex-col gap-3 animate-slide-in">
          ...
          <button
            ...
            className="w-full py-2 rounded-md bg-bull/90 hover:bg-bull text-black text-xs font-semibold transition-colors"
          >
            Open Full Analysis →
          </button>
        </div>
